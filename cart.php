    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-end mb-2">
                <button class="btn btn-outline-dark btn-flat btn-sm" type="button" id="empty_cart">Dọn sạch giỏ
                    hàng</button>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                    <div class="d-flex align-items-center col-8">
                        ...
                        <img src="<?php echo validate_image($img) ?>" loading="lazy"
                        ...
                        <div>
                            ...
                            <p class="mb-1 mb-sm-1"><small><b>Giá:</b> <span
                                        class="price"><?php echo number_format($row['price']) ?> vnđ</span></small></p>
                            <div>
                    ...
                    <div class="col text-right align-items-center d-flex justify-content-end">
                        <h4><b class="total-amount"><?php echo number_format($row['price'] * $row['quantity']) ?></b>
                            vnđ
                        </h4>
                    </div>
                </div>
...
$(function() {
    ...
    $('#empty_cart').click(function() {
        // empty_cart()
        _conf("Bạn có chắc chắn xóa danh sách giỏ hàng của mình không?", 'empty_cart', [])
    })
    $('.rem_item').click(function() {
        _conf("Bạn có chắc chắn xóa mặt hàng trong danh sách giỏ hàng?", 'rem_item', [$(this).attr(
            'data-id')])
    })
})
</script>