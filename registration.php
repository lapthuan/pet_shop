...
<div class="container-fluid">
    <form action="" id="registration">
        <div class="row">
            ...
            <h3 class="text-center">Đăng ký tài khoản
        ...
        <div class="row  align-items-center h-100">
            ...
            <div class="col-lg-7">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="myInput" class="form-control form-control-sm form" name="password"
                        required>
                </div>
                <div class="form-group">
                    <label for="" class="control-label">Nhập lại mật khẩu</label>
                    <input type="password" id="myInput-rp" class="form-control form-control-sm form" name="password-rp"
                        required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group d-flex justify-content-between">
                    ...
                    <p>Bạn đã tài khản trở về <a href="javascript:void()" id="login-show"
    ...
    $('#registration').submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                } else if (resp.status == 'failed2' && !!resp.msg) {
                    var _err_el = $('<div>')
                    _err_el.addClass("alert alert-danger err-msg").text(resp.msg)
                    $('[name="password-rp"]').after(_err_el)
                    end_loader()
