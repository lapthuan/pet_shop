    ...
    <div class="container">
        <div class="card rounded-0">
            ...
            <div class="row row-col-1 justify-content-center">
                ...
                <div class="col-6">
                    <div class="card">
                        <h4 class="px-2 py-2">Thông tin nhận hàng</h4>
                        <div class="card-body">
                            <p>Họ tên:
                                <?php echo ($_settings->userdata('firstname')." ". $_settings->userdata('lastname'))  ?>
                            </p>
                            <p>Số điện thoại: <?php echo $_settings->userdata('contact') ?></p>

                            <p>Giới tính:
                                <?php echo $_settings->userdata('gender')?>
                            </p>
                            <p>Email: <?php echo $_settings->userdata('email') ?></p>
                        </div>
                    </div>
            ...
            <form action="" id="place_order">
                ...
                <div class="row row-col-1 justify-content-center">
                    <div class="col-6">
                        ...
                        <div class="col">
                            <span>
                                <h4><b>Tông cộng:</b> <?php echo number_format($total) ?> vnđ</h4>
                            </span>
                        </div>
                        <hr>
                        <div class="col my-3">
