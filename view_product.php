    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <h1 class="display-5 fw-bolder text-primary "><?php echo $product_name ?></h1>
                <div class="fs-5 mb-5">
               <span id="price"><?php echo $inv[0]['price'] ?> </span> vnđ
                <br>
                <span><small><b>Số lượng còn:</b> <span id="avail"><?php echo $inv[0]['quantity'] ?></span></small></span>
                </div>
            ...
            <div class="col mb-5">
                <div class="card h-100 product-item">
                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center">
                            <a class="btn btn-flat btn-primary rounded-1"   href=".?p=view_product&id=<?php echo md5($row['id']) ?>">Xem chi tiết</a>
                        </div>
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(typeof resp == 'object' && resp.status=='success'){
                        alert_toast("Sản phẩm đã được thêm vào giỏ hàng.",'success')
