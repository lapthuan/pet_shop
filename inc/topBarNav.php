    ...
    <div class="container px-4 px-lg-5 ">
        ...
        <form class="form-inline" id="search-form">
            <div class="input-group">
                <input class="form-control form-control-sm form " type="search" placeholder="Tìm kiếm"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <li class="nav-item"><a class="nav-link" href="./?p=team">Thành viên</a></li>
                <li class="nav-item"><a class="nav-link" href="./?p=about">Về chúng tôi</a></li>
                <li class="nav-item"><a class="nav-link" href="./?p=location">Địa chỉ</a></li>
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="./?p=my_account" class="text-dark  nav-link"><b> Hi,
                        <?php echo $_settings->userdata('lastname')?>!</b></a>
