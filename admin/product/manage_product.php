	...
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <div class="form-group">
                ...
                <option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Dừng kích hoạt</option>
                </select>
			</div>
            <div class="form-group">
                ...
                <small><i>Đè Shift để chọn nhiều ảnh.</i></small>
...
<script>
	...
	$(document).ready(function(){
        ...
        $('#category_id').change(function(){
            ...
            $('#sub_category_id').select2({placeholder:"Vui lòng chọn ở đây",width:"relative"})
        })
        $('.select2').select2({placeholder:"Vui lòng chọn ở đây",width:"relative"})
